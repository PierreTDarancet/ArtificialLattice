# Modified form of kwant.plot(). Used to make images with constant field of 
# view in order to train the neural network
...
from kwant import system, builder, _common
